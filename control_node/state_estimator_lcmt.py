...
class state_estimator_lcmt(object):
    __slots__ = ["p", "vWorld", "vBody", "p_abs", "vWorld_abs", "vBody_abs", "vRemoter", "rpy", "omegaBody", "omegaWorld", "quat", "aBody", "aWorld", "contactEstimate", "timestamp"]

    __typenames__ = ["float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "int64_t"]

    __dimensions__ = [[3], [3], [3], [3], [3], [3], [3], [3], [3], [3], [4], [3], [3], [4], None]

    def __init__(self):
        self.p = [ 0.0 for dim0 in range(3) ]
        self.vWorld = [ 0.0 for dim0 in range(3) ]
        self.vBody = [ 0.0 for dim0 in range(3) ]
        self.p_abs = [ 0.0 for dim0 in range(3) ]
        self.vWorld_abs = [ 0.0 for dim0 in range(3) ]
        self.vBody_abs = [ 0.0 for dim0 in range(3) ]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack('>3f', *self.p_abs[:3]))
        buf.write(struct.pack('>3f', *self.vWorld_abs[:3]))
        buf.write(struct.pack('>3f', *self.vBody_abs[:3]))
    ...
    def _decode_one(buf):
        ...
        self.p_abs = struct.unpack('>3f', buf.read(12))
        self.vWorld_abs = struct.unpack('>3f', buf.read(12))
        self.vBody_abs = struct.unpack('>3f', buf.read(12))
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xc69618890a997af) & 0xffffffffffffffff
